...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] argv) {
       Jedis jedis = new Jedis("redis://localhost:6379/9");
        ...
        jedis.sadd("password","123456");
        jedis.sadd("name","tony");
        jedis.srem("name","tony");
        System.out.println(jedis.spop("name"));
        System.out.println(jedis.spop("password"));*/


        // get set,字符串结构，key,value方式存储
    ...
    public long scard(String key) {//求集合元素的的数量
        Jedis jedis = null;
        try {
            jedis = pool.getResource();
